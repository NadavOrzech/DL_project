...
def get_ecg_data(datfile): 
    ...
    recordname = datfile.split(".dat")[0]
...
class Record:
    def __init__(self):
        ...
        self.record = wfdb.rdsamp(self.file_name)
        self.ann = wfdb.rdann(self.file_name,extension="atr")


    def visualization(self):
        wfdb.plotrec(self.record, annotation = self.ann, title='Record 100 from MIT-BIH Arrhythmia Database', timeunits = 'seconds', figsize = (10,4), ecggrids = 'all')
...
if __name__ == '__main__':
    ...
    get_ecg_data("C:\\Users\\Dell\\Desktop\\Technion\\DeepLearning\\project_data\\mit-bih\\files\\04936.dat")
